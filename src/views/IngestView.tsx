...
export function IngestView() {
  ...
  const filterCount = useCallback((key: FilterType) => {
    if (key === 'all') return sources.length + 1
    if (key === 'api') return 1
            ...
            <div style={{ marginBottom: groupedSources.length > 0 && filter === 'all' ? 28 : 0 }}>
              ...
              >
                <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                  ...
                  <div>
                    <div className="font-display" style={{ fontSize: 14, fontWeight: 600, color: 'var(--color-text-primary)' }}>
                      API &amp; MCP Access
                    </div>
                    <div className="font-body" style={{ fontSize: 12, color: 'var(--color-text-secondary)', marginTop: 1 }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: 2, flexShrink: 0 }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                    <div style={{ width: 7, height: 7, borderRadius: '50%', background: apiKeys.length > 0 ? '#10b981' : 'var(--color-text-secondary)' }} />
                    <span className="font-body" style={{ fontSize: 12, color: 'var(--color-text-secondary)' }}>
